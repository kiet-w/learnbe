...
![Bản đồ hoạt động nhà hàng](../visuals/restaurant_flow_illustration.png)
...
---
*Bản hướng dẫn này được lưu trữ tại [docs/learning/NESTJS_RESTAURANT_METAPHOR.md](NESTJS_RESTAURANT_METAPHOR.md) để bạn dễ dàng tra cứu bất kỳ lúc nào.*
