...
**Goal:** Build a standalone dark-mode `index.html` that turns the local `docs/learning/LEARN.md` roadmap into a structured NestJS learning dashboard with priorities, tasks, backend flow, production checklist, and debugging playbooks.
...
- Existing input: `docs/learning/LEARN.md`
