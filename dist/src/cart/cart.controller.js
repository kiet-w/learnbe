...
let CartController = class CartController {
    ...
    async getCart(request) {
        ...
        return (0, api_response_util_1.success)(cart);
    }
    async addItem(request, dto) {
        const cart = await this.cartService.addItem(request.user.userId, dto);
        return (0, api_response_util_1.success)(cart);
    }
    async updateItem(request, id, dto) {
        const cart = await this.cartService.updateItem(request.user.userId, id, dto);
        return (0, api_response_util_1.success)(cart);
    }
    async removeItem(request, id) {
