...
let OrdersController = class OrdersController {
    ...
    async getOrders(request) {
        ...
        return (0, api_response_util_1.success)(orders);
    }
    async getOrderById(request, id) {
        const order = await this.ordersService.findOrderById(request.user.userId, id);
        return (0, api_response_util_1.success)(order);
    }
};
