...
let AdminCategoriesController = class AdminCategoriesController {
    ...
    async createCategory(request, dto) {
        const category = await this.adminCategoriesService.createCategory(request.user.userId, dto);
        return (0, api_response_util_1.success)(category);
    }
    async updateCategory(request, id, dto) {
        const category = await this.adminCategoriesService.updateCategory(request.user.userId, id, dto);
        return (0, api_response_util_1.success)(category);
    }
};
